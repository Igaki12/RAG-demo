...
-- 11. question_answers: 「クイズに回答した」ログ（セッション単位ではない）
CREATE TABLE IF NOT EXISTS question_answers (
  ...
  answer_mode   VARCHAR(32) NOT NULL, -- 'from_article', 'random_quiz', 'review' など
...
-- 12. question_stats: 設問ごとの統計（一般正解率など）
...
-- 13. choice_stats: 選択肢ごとの統計（選択率など）
...
-- 14. daily_user_stats: ユーザー × 日付の集計
...
DB_NAME=rag_demo
	...
	•	クイズ回答ログ:
	•	/api/questions/:id/answer で question_answers に INSERT（answer_mode を指定）
	•	統計更新:
